...
class NavTest():
    def __init__(self):
        rospy.init_node('Ish_nav_test', anonymous=True)
       ...
       # locations['dining_room_1'] = Pose(Point(-0.861, -0.019, 0.000), Quaternion(0.000, 0.000, 0.892, -0.451))
        ...
        locations['a'] = Pose(Point(-1.459, 4.403, 0.000), Quaternion(0.000, 0.000, 0.000, 1.000))
        locations['b'] = Pose(Point(-5.550, 3.825, 0.000), Quaternion(0.000, 0.000, -0.009, 1.000))
        locations['c'] = Pose(Point(-7.093, 4.337, 0.000), Quaternion(0.000, 0.000, -0.065, 0.998))
        locations['d'] = Pose(Point(2.431, -0.564, 0.000), Quaternion(0.000, 0.000, -0.096, 0.995))
        locations['e'] = Pose(Point(1.905, 4.148, 0.000),  Quaternion(0.000, 0.000, 0.761, 0.649))
        locations['f'] = Pose(Point(-3.429, 6.541, 0.000), Quaternion(0.000, 0.000, 0.733, 0.681))
        locations['g'] = Pose(Point(-4.072, -0.692, 0.000), Quaternion(0.000, 0.000, -0.728, 0.686))
        locations['h'] = Pose(Point(2.976, 6.284, 0.000), Quaternion(0.000, 0.000, 0.016, 1.000))
